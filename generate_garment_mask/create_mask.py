...
def generate_and_save_masks(image_path, output_dir, garment_type):
    ...
    if len(contours) > 0:
        ...
        contour_path = output_dir / f'contour_mask.png'
        rectangle_path = output_dir / f'rectangle_mask.png'
        trapezium_path = output_dir / f'trapezium_mask.png'
        mask_path = output_dir / f'mask_outline.png'
